...
const Landing: React.FC = () => {
  return (
    <>
      <LandingNavBar />
      <div className="landing-curve css-fade-fast">
        <div className="container-sm pt-5">
          <div className="landing-text-container text-wrap text-center css-fade">
            <p className="landing-title">
              Track your <b>Net Worth</b> and make the most educated choices with your money!
            </p>
          </div>
          <div className="d-flex flex-row row mt-5 justify-content-evenly">
            <LandingCard
              icon={<Book />}
              title="Keep track"
